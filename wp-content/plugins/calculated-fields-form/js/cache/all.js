...
{return _getField(_field,_form);};lib.validform=lib.VALIDFORM=lib.ValidForm=function(_form,_silent){_silent=_silent||false;var o=_getForm(_form),f;if(o){f=$('[id="'+$.fbuilder.forms[o]['formId']+'"]');if(f.length)return _silent?f.validate().checkForm():f.valid();}
...
{fbuilderjQuery['fbuilder']['extend_window'](fbuilderjQuery['fbuilder']['modules']['text']['prefix'],CF_TEXT);}};$.fbuilder['version']='1.1.133';$.fbuilder['controls']=$.fbuilder['controls']||{};$.fbuilder['forms']=$.fbuilder['forms']||{};$.fbuilder['htmlEncode']=window['cff_esc_attr']=function(value)
...
catch(err){}});$(window).on('load',function(){$.fbuilder.manageHistory(true);});$(document).on('click','#fbuilder .cff-spinner-down,#fbuilder .cff-spinner-up',function(){var u=$(this).hasClass('cff-spinner-up'),e=$(this)[u?'prev':'next']('input'),o,s,m,v;if(e.length){o=getField(e.attr('id'),e[0].form);s=e.attr('step')||1;m=e.attr(u?'max':'min');v=o.val();if(e.hasClass('percent')){v=PREC(v*100,4)*1;}
if(u)v+=s;else v-=s;if(m)v=u?MIN(v,m):MAX(v,m);o.setVal(v);e.valid();}});function assign_data_cff_field_content(field){try{field=$(field);var field_name=field.attr('name').match(/fieldname\d+/)[0];form_obj=field.closest('form'),tags=form_obj.find('[data-cff-field="'+field_name+'"]');if(tags.length){var ignore=field.hasClass('ignore'),field_obj=getField(field,form_obj),value=(ignore||!field_obj)?'':field_obj.val(true,true);value=Array.isArray(value)?value.join(', '):value;tags.each(function(){$(this).html(value);});}}catch(err){}};$(document).on('change keyup','#fbuilder :input[name*="fieldname"]',function(){assign_data_cff_field_content(this);});$(document).one('showHideDepEvent',function(){try{var form_obj=$('#'+arguments[1]);form_obj.find('[data-cff-field]').each(function(){try{var tag_obj=$(this),field_name=tag_obj.attr('data-cff-field'),field_obj;if(field_name.length&&/fieldname\d+/.test(field_name)){field_obj=form_obj.find('[name*="'+field_name+'_"]');if(field_obj.length)assign_data_cff_field_content(field_obj);}}catch(err){}});}catch(err){}});$.fbuilder.controls['ftext']=function(){};$.extend($.fbuilder.controls['ftext'].prototype,$.fbuilder.controls['ffields'].prototype,{title:"Untitled",ftype:"ftext",autocomplete:"off",predefined:"",predefinedClick:false,required:false,readonly:false,size:"medium",minlength:"",maxlength:"",equalTo:"",regExp:"",regExpMssg:"",show:function()
...
return(typeof v=='object'&&typeof v['length']!=='undefined')?v:((v)?(($.isNumeric(v)||no_quotes)?v:'"'+v+'"'):0);},setVal:function(v,nochange,_default)
